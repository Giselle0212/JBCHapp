...
const RegForm = (props) => {
    ...
    const createAttendeeCounsel = (e) => {
        e.preventDefault();

        const userCounsel = { nombre, apellido, predicador };

        axios.post('http://localhost:8000/api/attendees/Counselling', userCounsel)
            .then(res => {
    ...
    return (
        <div className="mainContainer">
            ...
            <form onSubmit={createAttendeeCounsel}>
                ...
                <div className="formContainer" >
                    ...
                    <div>
                            <label htmlFor="">Predicador</label>
                            <select id="iglesia" onChange={(e) => setPredicador(e.target.value)} value={predicador} required>
                                <option value="Pablo Kim">Pablo Kim</option>
