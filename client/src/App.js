...
//  admin forms
import AdminReg from './AdminForms/AdminReg'
import AdminLogin from './AdminForms/AdminLogin';
import ResetForm from './AdminForms/PasswordRequest'
import NewPassword from './AdminForms/NewPassword'
function App() {
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/password/rest' element={<ResetForm />} />
